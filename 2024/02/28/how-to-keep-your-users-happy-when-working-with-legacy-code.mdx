...
show: true
synopsis: 'I have a confession to make: I love clean code. Almost unreasonably so. This passion used to get me into trouble when I cleaned up messy code. Extensive manual testing confirmed that my refactored so'
---
