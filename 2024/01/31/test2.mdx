...
title: 'Test2'
date: '2024-01-31'
src: 'https://raw.githubusercontent.com/olafthielke/1percentdev-blog/main/2024/01/31/feature-test2.png'
tags: ['career advice', 'mistakes', 'advantages']
show: false
synopsis: 'Just go faster. Easier said than done. As a junior developer, I wanted to get to senior dev quickly. When I asked senior developers how to get there, they said I''d have to put in lots of work. I did, '
---
...
<CustomImage src="https://raw.githubusercontent.com/olafthielke/1percentdev-blog/main/2024/01/31/dirty-code-vs-clean-code.png" alt="Dirty Code versus Clean Code. An illustration." />
...
Early in my career, I focussed almost exclusively on new tech: 
- Sybase Database, 
- ActiveX browser extensions, 
...
Just know you will seldom need to crack complex algorithms in your career[2].
...
- **Teamwork and Collaboration** - Software development is a team sport. Producing great code and not being able to work well in teams will hurt your career like nothing else. Play nicely with others.
...
- **Psychology** - Gaining a deeper understanding of human nature and how we operate will assist you in all walks of life, e.g. pay negotiations, marketing, etc. [3]
...
Once you understand a principle, it will benefit your software development for the rest of your career. 

It doesn't get much better than that, right?

Many top performers credit their success to this simple, invaluable concept:
...
- **Working Safely with Legacy Code** - because there is so much of it
...
It sounds unbelievable that you will learn more by teaching material *you already know*. Yet, there is no arguing with results.

You may not know much, yet there will be someone who doesn't know what you do.
...
- **Gateway to Leadership**: Teaching, mentoring and helping others gets the team unstuck and performing to its potential. You're demonstrating engineering leadership! If this is where you want to go, do more of it.
...
4. It's not an exhaustive list. E.g. learning a new programming language from time to time is a productive activity too.