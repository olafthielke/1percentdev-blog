...
One of the things that irks me most is the hard-coded email body. As you can imagine, email text changes at the drop hat. 
...
Let abstract away this repository of email templates as IEmailTemplateRepository, including a method to look up templates by name:
