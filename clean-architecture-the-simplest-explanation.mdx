...
Until that fateful day, when I learned about Clean Architecture (CA) from an [Uncle Bob video](https://cleancoders.com/).
...
**Clean Architecture** is a revolutionary approach for designing highly maintainable, pluggable software systems. 

As such it is extremely useful when building complex, yet robust software systems where flexibility to make significant modifications is needed. 
...
Business Logic represents the program's behaviour independent of technologies, like the web and database.
