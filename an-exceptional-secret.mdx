...
<CustomImage src="https://raw.githubusercontent.com/olafthielke/1percentdev-blog/main/images/result-pattern-outcomes.png" alt="Possible Outcomes form Result Pattern" />
...
First, after the call to Validate(), andafter the call to the RegisterUseCase.RegisterCustomer()
